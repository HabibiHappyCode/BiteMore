...
const SERVEDATA = [
    {
        ...
        icon: <FiSunrise />,
        text: 'Breakfast',
        paragraph: 'Kickstart your day with balanced, energizing options.'
    },
    {
        id: 2,
        icon: <PiForkKnifeBold />,
        text: 'Lunch',
        paragraph: 'Quick, tasty plates for productive afternoons.'
    },
    {
        id: 3,
        icon: <IoMoonOutline />,
        text: 'Dinner',
        paragraph: 'Comfort classics and chef specials for evenings'
    },
    {
        id: 4,
        icon: <LuCookie />,
        text: 'Snacks',
        paragraph: 'Light bites and sides to keep cravings in check.'
    },
]
function Serve() {
    return (
        <div className="">
            <article className="mb-12 max-md:mb-9">
                <h1 className="font-strike text-[#0F172A] text-[2.8em] max-lg:text-[2em] text-center font-bold">What we serve</h1>
                <p className="text-black/80 text-[1.1em] max-md:text-[.9em] text-center max-lg:text-[1em]">Curated for every moment—breakfasts, quick lunches, hearty dinners and smart snacks.</p>
            </article>
